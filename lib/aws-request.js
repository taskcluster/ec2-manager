...
const MAX_REQUEST_DURATION = 10 * 1000; // 10s
 ...
 */
async function runAWSRequest(service, method, body, state, maxDuration=MAX_REQUEST_DURATION) {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    let timeout = setTimeout(() => request.abort(), maxDuration);
